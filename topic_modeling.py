...
# Begin topic modeling by creating the model  may also use [all-mpnet-base-v2] or [allenai/scibert_scivocab_uncased]
representation_model = KeyBERTInspired()
model = BERTopic(embedding_model="all-MiniLM-L6-v2", representation_model= representation_model)
